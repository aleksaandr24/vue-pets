<template>
  <div
    :class="'base-avatar base-avatar_' + elemSize + ' ' + elemClass"
  >
    <div
      v-show="online"
      :class="'base-avatar__badge base-avatar__badge_' + elemSize"
    >
    </div>
    <div
      :class="'base-avatar__circle base-avatar__circle_' + elemSize + ' ' + backgroundColorClass"
    >
      <img
        v-if="showPicture"
        :src="picturePath"
      ...
      <div
        v-else
        :class="'base-avatar__name base-avatar__name_' + elemSize"
      >
        {{ userName }}
      </div>
    </div>
  ...
  computed: {
    ...
    userName() {
      ...
      if (nameArray.length > 1) {
        ...
        userLiters.push(nameArray[0].charAt(1))
      }
